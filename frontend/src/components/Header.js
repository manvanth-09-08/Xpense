...
//         <Navbar.Brand href="/" className="text-white navTitle">XPENS</Navbar.Brand>
//         <Navbar.Toggle
      ...
      <div style={{ position: 'relative', overflow: 'hidden' }}>
        ...
        >
          <Container  >
            ...
            <Navbar.Toggle aria-controls="responsive-navbar-nav" style={{ borderColor: 'white'}}> <span className="navbar-toggler-icon"></span></Navbar.Toggle>
